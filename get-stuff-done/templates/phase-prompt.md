...
<!-- For checkpoint task examples and patterns, see @~/.claude/get-stuff-done/references/checkpoints.md -->
...
See `~/.claude/get-stuff-done/references/tdd.md` for TDD plan structure.
...
See `~/.claude/get-stuff-done/templates/user-setup.md` for full schema and examples
...
See `~/.claude/get-stuff-done/workflows/verify-phase.md` for verification logic.
