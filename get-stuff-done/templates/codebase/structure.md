...
├── get-stuff-done/     # Skill resources
...
**New Template:**
- Implementation: `get-stuff-done/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `get-stuff-done/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/get-stuff-done/workflows/{name}.md`
