...
```bash
git clone https://github.com/joshlopez1588/get-stuff-done.git /tmp/gsd-install && node /tmp/gsd-install/bin/install.js --claude --global && rm -rf /tmp/gsd-install
```
...
- Better than manual git clone + install
