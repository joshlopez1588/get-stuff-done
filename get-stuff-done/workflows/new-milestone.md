...
```bash
node ~/.claude/get-stuff-done/bin/gsd-tools.cjs commit "docs: start milestone v[X.Y] [Name]" --files .planning/PROJECT.md .planning/STATE.md
```

## 7. Load Context and Resolve Models

```bash
INIT=$(node ~/.claude/get-stuff-done/bin/gsd-tools.cjs init new-milestone)
```
...
node ~/.claude/get-stuff-done/bin/gsd-tools.cjs config-set workflow.research true

# If "Skip research": persist false
node ~/.claude/get-stuff-done/bin/gsd-tools.cjs config-set workflow.research false
```
...
Use template: ~/.claude/get-stuff-done/templates/research-project/{FILE}
</output>
...
**Commit requirements:**
```bash
node ~/.claude/get-stuff-done/bin/gsd-tools.cjs commit "docs: define milestone v[X.Y] requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
node ~/.claude/get-stuff-done/bin/gsd-tools.cjs commit "docs: create milestone v[X.Y] roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
