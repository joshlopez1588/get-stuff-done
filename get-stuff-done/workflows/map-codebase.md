...
```bash
INIT=$(node ~/.claude/get-stuff-done/bin/gsd-tools.js init map-codebase)
```
...
```bash
node ~/.claude/get-stuff-done/bin/gsd-tools.js commit "docs: map existing codebase" --files .planning/codebase/*.md
```
