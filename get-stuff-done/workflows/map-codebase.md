...
```bash
INIT=$(node ~/.claude/get-stuff-done/bin/gsd-tools.cjs init map-codebase)
```
...
```bash
node ~/.claude/get-stuff-done/bin/gsd-tools.cjs commit "docs: map existing codebase" --files .planning/codebase/*.md
```
