...
```bash
INIT_RAW=$(node ~/.claude/get-stuff-done/bin/gsd-tools.cjs init progress --include state,roadmap,project,config)
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node ~/.claude/get-stuff-done/bin/gsd-tools.cjs summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node ~/.claude/get-stuff-done/bin/gsd-tools.cjs progress bar --raw)
```
