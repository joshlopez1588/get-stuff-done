...
See ~/.claude/get-stuff-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/get-stuff-done/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/get-stuff-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/get-stuff-done/templates/discovery.md
...
Use ~/.claude/get-stuff-done/templates/discovery.md.
