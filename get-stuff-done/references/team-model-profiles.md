...
This reference extends `~/.claude/get-stuff-done/references/model-profiles.md` with team-specific agent roles.
...
- Cross-reference `~/.claude/get-stuff-done/references/model-profiles.md` for the standard agent profile table.
- Cross-reference `~/.claude/get-stuff-done/references/model-profile-resolution.md` for the general resolution pattern.
- Cross-reference `~/.claude/get-stuff-done/references/team-orchestration.md` for how model profiles are applied during team execution.
