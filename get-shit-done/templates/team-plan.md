...
@~/.claude/get-shit-done/references/team-orchestration.md
...
- Cross-reference `~/.claude/get-shit-done/references/team-orchestration.md` for coordination protocol.
- Cross-reference `~/.claude/get-shit-done/references/team-handoff-protocol.md` for handoff patterns.
