...
node ~/.claude/get-shit-done/bin/gsd-tools.js team-state update \
...
**On task completion:**
```bash
node ~/.claude/get-shit-done/bin/gsd-tools.js team-state task-complete \
  --phase "02" --plan "01" --team "backend" \
...
**On plan completion:**
```bash
node ~/.claude/get-shit-done/bin/gsd-tools.js team-state complete \
  --phase "02" --plan "01" --team "backend" \
...
**On failure:**
```bash
node ~/.claude/get-shit-done/bin/gsd-tools.js team-state fail \
  --phase "02" --plan "01" --team "backend" \
...
node ~/.claude/get-shit-done/bin/gsd-tools.js team-state list --phase "02"

# Check if wave is complete
node ~/.claude/get-shit-done/bin/gsd-tools.js team-state wave-check \
  --phase "02" --wave 1

# Detect conflicts
node ~/.claude/get-shit-done/bin/gsd-tools.js team-state conflicts --phase "02"
...
- Cross-reference `~/.claude/get-shit-done/references/team-orchestration.md` for how state fits into the overall coordination protocol.
- Cross-reference `~/.claude/get-shit-done/references/team-handoff-protocol.md` for how state enables handoffs.
