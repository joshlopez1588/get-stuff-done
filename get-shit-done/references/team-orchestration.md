...
See `~/.claude/get-shit-done/references/team-model-profiles.md` for model assignments per agent.
See `~/.claude/get-shit-done/references/team-handoff-protocol.md` for how teams pass work.
See `~/.claude/get-shit-done/references/team-state-format.md` for shared state format.
